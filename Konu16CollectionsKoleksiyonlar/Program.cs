...
namespace Konu16CollectionsKoleksiyonlar
{
    internal class Program
    {
        ...
        static void Ornek1()
        {
            ...
            Console.WriteLine("Arraylist ilk eleman : " + arrayList[0]); // listedeki index ini verdiğimiz elemana ulaşma
        }
        static void Ornek2()
        {
            ArrayList arrayList = new ArrayList();
            arrayList.Add("İstanbul"); // araryList e Add metoduyla veri eklenir
        ...
        static void Ornek5()
        {
            StringDictionary dictionary = new StringDictionary(); // key value şeklinde saklayabilir
        ...
        static void Ornek6()
        {
            Stack stack = new Stack(); // Stack sınıfı proglamlamada LIFO - son giren ilk çıkar kuralıyla çalışır.
        ...
        static void Ornek7()
        {
            Queue queue = new Queue(); //Queue sınıfı proglamlamada FIFO - İlk giren ilk çıkar mantığıyla çalışır
            queue.Enqueue("Lale");
            queue.Enqueue("Gül");
        ...
        static void Ornek8()
        {
            ...
            Console.WriteLine("dictionary2 Valuess");
        ...
        static void ListKullanimi()
        {
            ...
            Console.WriteLine();
            kullanicilar.AddRange(users); // Kullanıcılar listesine çoklu ekleme içinAddRange metodu kullanılır.
            Console.WriteLine("Kullanıcılar(kullanicilar) : ");
            foreach (var item in kullanicilar)
            {
                Console.WriteLine(item.Name);
            ...
            Console.WriteLine();
            Console.WriteLine("Kullanıcılar listesinde yeniKullanıcı var mı ? " + kullanicilar.Contains(yeniKullanici));
            kullanicilar.Add(yeniKullanici); // Kullanilar a yeni kullanici yı ekle
            foreach (var item in kullanicilar)
            {
                Console.WriteLine(item.Name); 
            }
